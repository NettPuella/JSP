...
영역이다. JSP에서의 영역(Object형을 기반으로 함: 그렇기에 박싱처리를 해야함)은 
데이터를 저장하는 공간으로 메모리라고 생각하면 된다.
*/
//정수형(Integer) 데이터
pageContext.setAttribute("pageInteger", 1000);
//문자열(String) 데이터
pageContext.setAttribute("pageString", "페이지 영역의 문자열");
//Person형: 일반적인 클래스를 통해 직접 생성한 인스턴스
...
<a href="PageLocation.jsp">PageLacation.jsp 바로가기</a>
</body>
</html>
