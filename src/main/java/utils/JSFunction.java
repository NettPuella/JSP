...
public class JSFunction {
	...
	public static void alertLocation(String msg, String url, JspWriter out) {
		/* Java클래스에서는 JSP의 내정객체를 즉시 사용할 수 없으므로
	...
	/* 상단 2개의 메서드는 JSP에서 사용하기 위해 정의였다. JSP에서 out
	내장객체를 전달하면 매개변수로 받아서 사용한다.
	아래 2개는 서블릿(Setvlet)에서 사용하기 위해 메서드 오버로딩을 통해
	정의하였다. 서블릿이 직접 요청을 받으므로 response 내장객체를 통해
	...
	public static void alertLocation(HttpServletResponse resp, String msg, 
		...
		try {
			...
			//PrintWrite 객체를 통해 스크립트를 서블릿에서 직접 호출한다.
